...
class XMLHelperTest {
    ...
    void testGetFileType_OFI() {
        String ofiXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<Funds>" + "  <Fund>"
                + "    <CountrySpecificData>" + "      <AT>" + "        <OeNB>"
                + "          <Meldungstyp>OFI</Meldungstyp>" + "        </OeNB>" + "      </AT>"
                + "    </CountrySpecificData>" + "  </Fund>" + "</Funds>";
    ...
    void testGetFileType_FundData() {
        String fundDataXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<Funds>" + "  <Fund></Fund>" + "</Funds>";
    ...
    void testGetFileType_AccessRights() {
        String accessRightsXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<AccessRules>" + "  <Rule></Rule>"
                + "</AccessRules>";
    ...
    void testGetFileType_Unknown() {
        String unknownXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<UnknownType>" + "  <Data></Data>"
                + "</UnknownType>";
    ...
    void testGetFileType_MalformedXML() {
        String malformedXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + "<Funds>" + "  <Fund>"; // Missing closing
                                                                                                     // tags
