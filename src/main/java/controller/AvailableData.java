...
public class AvailableData implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        fdpContentCombo.setItems(FXCollections.observableArrayList("FUND", "REG", "DOC"));
        ...
        infoLabel.setText(
                "Hinweis: Upload-Zeitraum maximal 7 Tage. Wenn ContentDate gesetzt ist, werden Upload-Zeiten ignoriert.");
    }
    ...
    private void download() {
        ...
        new Thread(() -> {
            try {
                ...
                String result = new OeKBHTTP().downloadAvailableData(contentDate, uploadTimeFrom, uploadTimeTo,
                        fdpContent, params);
