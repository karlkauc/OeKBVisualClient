...
public class MainController implements Initializable {
	...
	private void changeToSettings() {
		...
		try {
			javafx.scene.Parent tempPane = FXMLLoader
					.load(getClass().getClassLoader().getResource("pages/pageApplicationSettings.fxml"));
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageAccesRightsReceived.fxml"));
				mainPane.getChildren().setAll(tempPane);
	...
	private void changeToAccessRightsGrant() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageAccessRightGrant.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToJournal() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageJournal.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToNewInformation() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageNewInformation.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToOFI() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageOFI_new.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToDataUpload() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageDataUpload.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToFundDownload() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageFundDownload.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToShareClassDownload() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageShareClassDownload.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToDocumentDownload() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageDocumentDownload.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToRegulatoryReporting() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageRegulatoryReporting.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToAbout() {
		...
		try {
			javafx.scene.Node tempPane = FXMLLoader
					.load(getClass().getClassLoader().getResource("pages/pageAbout.fxml"));
			mainPane.getChildren().setAll(tempPane);
			mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
		} catch (IOException e) {
	...
	private void changeToAvailableData() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageAvailableData.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
	...
	private void changeToOwnDataDownloaded() {
		...
		if (!hasValidSettings()) {
			...
			try {
				javafx.scene.Node tempPane = FXMLLoader
						.load(getClass().getClassLoader().getResource("pages/pageOwnDataDownloaded.fxml"));
				mainPane.getChildren().setAll(tempPane);
				mainPane.setPrefSize(mainPane.getMaxWidth(), mainPane.getMaxHeight());
			} catch (IOException e) {
