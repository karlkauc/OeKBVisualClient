...
public final class ApplicationSettings implements IApplicationSettings {
    ...
    public boolean saveSettingsDataToFile(String fileName) {
        try {
            ...
            createElement(doc, proxyElement, "port",
                    connectionProxyPort != null ? String.valueOf(connectionProxyPort) : "");
            ...
            if (file.exists() && !file.delete()) {
                LOG.warn("Could not delete existing settings file: {}", file.getAbsolutePath());
            }
    ...
    public void readSettingsFromFile(String filename) {
        ...
        } catch (javax.xml.parsers.ParserConfigurationException | org.xml.sax.SAXException | IOException
    ...
    public String toString() {
        return "ApplicationSettings{" + "oekbUserName='" + oekbUserName + '\'' + ", connectionUseSystemSettings="
                + connectionUseSystemSettings + ", connectionProxyHost='" + connectionProxyHost + '\''
                + ", connectionProxyPort=" + connectionProxyPort + ", overwriteData=" + overwriteData
                + ", newAccesRuleId=" + newAccesRuleId + ", useProdServer=" + useProdServer + ", backupDirectory='"
                + backupDirectory + '\'' + ", fileSystem=" + fileSystem + ", dataSupplierList='" + dataSupplierList
                + '\'' + '}';
    }
}
