 ...
 * Indicates newly available data for download. Based on
...
public class NewInformationEntry {
    ...
    public String toString() {
        return "NewInformationEntry{" + "contentType=" + contentType + ", contentDate=" + contentDate
                + ", uploadDateTime=" + uploadDateTime + ", dataSuppliers=" + dataSuppliers.size() + ", lei='" + lei
                + '\'' + ", isins=" + isins.size() + '}';
    }
}
