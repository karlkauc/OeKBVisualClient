...
public final class RuleRow implements Comparable<RuleRow> {
	...
	public RuleRow(String id, String contentType, String profile, String dataSupplierCreatorShort,
			...
			String accessDelayInDays, String dateFrom, String dateTo, String frequency, String LEI, String OENB_ID,
	...
	public RuleRow(String id, String contentType, String profile, String dataSupplierCreatorShort,
			...
			String LEI, String OENB_ID, String SHARECLASS_ISIN, String SEGMENT_ISIN, boolean rootRow) {
		this.id = id;
		this.contentType = contentType;
		this.profile = profile;
		this.dataSupplierCreatorShort = dataSupplierCreatorShort;
	...
	public String toString() {
		return "RuleRow{" + "id='" + id + '\'' + ", contentType='" + contentType + '\'' + ", profile='" + profile + '\''
				...
				+ ", costsByDataSupplier=" + costsByDataSupplier + ", LEI='" + LEI + '\'' + ", OENB_ID='" + OENB_ID
				+ '\'' + ", SHARECLASS_ISIN='" + SHARECLASS_ISIN + '\'' + ", SEGMENT_ISIN='" + SEGMENT_ISIN + '\''
				+ ", rootRow=" + rootRow + '}';
	}
}
